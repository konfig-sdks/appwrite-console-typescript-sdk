...
// @ts-ignore
import { FunctionsCreateDeploymentRequest } from '../models';
// @ts-ignore
import { FunctionsCreateFunctionRequest } from '../models';
// @ts-ignore
...
// @ts-ignore
import { UsageFunction } from '../models';
// @ts-ignore
import { UsageFunctions } from '../models';
// @ts-ignore
...
export const FunctionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {FunctionsCreateDeploymentRequest} [functionsCreateDeploymentRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createDeployment: async (functionId: string, code: string, activate: boolean, entrypoint?: string, commands?: string, functionsCreateDeploymentRequest?: FunctionsCreateDeploymentRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'functionId' is not null or undefined
            assertParamExists('createDeployment', 'functionId', functionId)
            // verify required parameter 'code' is not null or undefined
            assertParamExists('createDeployment', 'code', code)
            // verify required parameter 'activate' is not null or undefined
            assertParamExists('createDeployment', 'activate', activate)
            ...
            requestBeforeHook({
                requestBody: functionsCreateDeploymentRequest,
         ...
         * @throws {RequiredError}
         */
        createFunction: async (functionsCreateFunctionRequest?: FunctionsCreateFunctionRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: functionsCreateFunctionRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
         ...
         * @throws {RequiredError}
         */
        deleteFunctionById: async (functionId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'functionId' is not null or undefined
            assertParamExists('deleteFunctionById', 'functionId', functionId)
         ...
         * @throws {RequiredError}
         */
        downloadDeploymentContents: async (functionId: string, deploymentId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'functionId' is not null or undefined
            assertParamExists('downloadDeploymentContents', 'functionId', functionId)
            // verify required parameter 'deploymentId' is not null or undefined
            assertParamExists('downloadDeploymentContents', 'deploymentId', deploymentId)
         ...
         * @throws {RequiredError}
         */
        getFunctionUsage: async (functionId: string, range?: '24h' | '30d' | '90d', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'functionId' is not null or undefined
            assertParamExists('getFunctionUsage', 'functionId', functionId)
            const localVarPath = `/functions/{functionId}/usage`
                .replace(`{${"functionId"}}`, encodeURIComponent(String(functionId !== undefined ? functionId : `-functionId-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/functions/{functionId}/usage',
                httpMethod: 'GET'
            });
        ...
        getUsageStats: async (range?: '24h' | '30d' | '90d', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/functions/usage`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        retryBuild: async (functionId: string, deploymentId: string, buildId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'functionId' is not null or undefined
            assertParamExists('retryBuild', 'functionId', functionId)
            // verify required parameter 'deploymentId' is not null or undefined
            assertParamExists('retryBuild', 'deploymentId', deploymentId)
            // verify required parameter 'buildId' is not null or undefined
            assertParamExists('retryBuild', 'buildId', buildId)
         ...
         * @throws {RequiredError}
         */
        updateDeploymentByFunctionAndId: async (functionId: string, deploymentId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'functionId' is not null or undefined
            assertParamExists('updateDeploymentByFunctionAndId', 'functionId', functionId)
            // verify required parameter 'deploymentId' is not null or undefined
            assertParamExists('updateDeploymentByFunctionAndId', 'deploymentId', deploymentId)
            const localVarPath = `/functions/{functionId}/deployments/{deploymentId}`
                .replace(`{${"functionId"}}`, encodeURIComponent(String(functionId !== undefined ? functionId : `-functionId-`)))
                .replace(`{${"deploymentId"}}`, encodeURIComponent(String(deploymentId !== undefined ? deploymentId : `-deploymentId-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const FunctionsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Create a new function code deployment. Use this endpoint to upload a new version of your code function. To execute your newly uploaded code, you\'ll need to update the function\'s deployment to use your new deployment UID.  This endpoint accepts a tar.gz file compressed with your code. Make sure to include any dependencies your code has within the compressed file. You can learn more about code packaging in the [Appwrite Cloud Functions tutorial](https://appwrite.io/docs/functions).  Use the \"command\" param to set the entrypoint used to execute your code.
         * @summary Create deployment
         * @param {FunctionsApiCreateDeploymentRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createDeployment(requestParameters: FunctionsApiCreateDeploymentRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Deployment>> {
            const functionsCreateDeploymentRequest: FunctionsCreateDeploymentRequest = {
                entrypoint: requestParameters.entrypoint,
                commands: requestParameters.commands,
                code: requestParameters.code,
                activate: requestParameters.activate
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createDeployment(requestParameters.functionId, requestParameters.code, requestParameters.activate, requestParameters.entrypoint, requestParameters.commands, functionsCreateDeploymentRequest, options);
         ...
         * @throws {RequiredError}
         */
        async createFunction(requestParameters: FunctionsApiCreateFunctionRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Function>> {
            const functionsCreateFunctionRequest: FunctionsCreateFunctionRequest = {
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.createFunction(functionsCreateFunctionRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Create a new function environment variable. These variables can be accessed in the function at runtime as environment variables.
         ...
         * Delete a function by its unique ID.
         * @summary Delete function
         * @param {FunctionsApiDeleteFunctionByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async deleteFunctionById(requestParameters: FunctionsApiDeleteFunctionByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteFunctionById(requestParameters.functionId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Delete a variable by its unique ID.
         ...
         * Get a Deployment\'s contents by its unique ID. This endpoint supports range requests for partial or streaming file download.
         * @summary Download Deployment
         * @param {FunctionsApiDownloadDeploymentContentsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async downloadDeploymentContents(requestParameters: FunctionsApiDownloadDeploymentContentsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.downloadDeploymentContents(requestParameters.functionId, requestParameters.deploymentId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a function by its unique ID.
         ...
         * 
         * @summary Get function usage
         * @param {FunctionsApiGetFunctionUsageRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getFunctionUsage(requestParameters: FunctionsApiGetFunctionUsageRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsageFunction>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getFunctionUsage(requestParameters.functionId, requestParameters.range, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         * @summary Get functions usage
         * @param {FunctionsApiGetUsageStatsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getUsageStats(requestParameters: FunctionsApiGetUsageStatsRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsageFunctions>> {
         ...
         * Get a list of all the project\'s functions. You can use the query params to filter your results.
         * @summary List functions
         * @param {FunctionsApiListAllRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listAll(requestParameters: FunctionsApiListAllRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FunctionList>> {
         ...
         * Create a new build for an Appwrite Function deployment. This endpoint can be used to retry a failed build.
         * @summary Create build
         * @param {FunctionsApiRetryBuildRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async retryBuild(requestParameters: FunctionsApiRetryBuildRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.retryBuild(requestParameters.functionId, requestParameters.deploymentId, requestParameters.buildId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Trigger a function execution. The returned object will return you the current execution status. You can ping the `Get Execution` endpoint to get updates on the current execution status. Once this endpoint is called, your function execution process will start asynchronously.
         ...
         * Update the function code deployment ID using the unique function ID. Use this endpoint to switch the code deployment that should be executed by the execution endpoint.
         * @summary Update function deployment
         * @param {FunctionsApiUpdateDeploymentByFunctionAndIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateDeploymentByFunctionAndId(requestParameters: FunctionsApiUpdateDeploymentByFunctionAndIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Function>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateDeploymentByFunctionAndId(requestParameters.functionId, requestParameters.deploymentId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update variable by its unique ID.
...
export const FunctionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createDeployment(requestParameters: FunctionsApiCreateDeploymentRequest, options?: AxiosRequestConfig): AxiosPromise<Deployment> {
            return localVarFp.createDeployment(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Create a new function. You can pass a list of [permissions](https://appwrite.io/docs/permissions) to allow different project users or team with access to execute the function using the client API.
         * @summary Create function
         ...
         * @throws {RequiredError}
         */
        createFunction(requestParameters: FunctionsApiCreateFunctionRequest, options?: AxiosRequestConfig): AxiosPromise<Function> {
            return localVarFp.createFunction(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Create a new function environment variable. These variables can be accessed in the function at runtime as environment variables.
         * @summary Create variable
         ...
         * @throws {RequiredError}
         */
        deleteFunctionById(requestParameters: FunctionsApiDeleteFunctionByIdRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteFunctionById(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete a variable by its unique ID.
         * @summary Delete variable
         ...
         * @throws {RequiredError}
         */
        downloadDeploymentContents(requestParameters: FunctionsApiDownloadDeploymentContentsRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.downloadDeploymentContents(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a function by its unique ID.
         * @summary Get function
         ...
         * @throws {RequiredError}
         */
        getFunctionUsage(requestParameters: FunctionsApiGetFunctionUsageRequest, options?: AxiosRequestConfig): AxiosPromise<UsageFunction> {
            return localVarFp.getFunctionUsage(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get functions usage
         ...
         * @throws {RequiredError}
         */
        getUsageStats(requestParameters: FunctionsApiGetUsageStatsRequest = {}, options?: AxiosRequestConfig): AxiosPromise<UsageFunctions> {
         ...
         * @throws {RequiredError}
         */
        listAll(requestParameters: FunctionsApiListAllRequest, options?: AxiosRequestConfig): AxiosPromise<FunctionList> {
         ...
         * @throws {RequiredError}
         */
        retryBuild(requestParameters: FunctionsApiRetryBuildRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.retryBuild(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Trigger a function execution. The returned object will return you the current execution status. You can ping the `Get Execution` endpoint to get updates on the current execution status. Once this endpoint is called, your function execution process will start asynchronously.
         * @summary Create execution
         ...
         * @throws {RequiredError}
         */
        updateDeploymentByFunctionAndId(requestParameters: FunctionsApiUpdateDeploymentByFunctionAndIdRequest, options?: AxiosRequestConfig): AxiosPromise<Function> {
            return localVarFp.updateDeploymentByFunctionAndId(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Update variable by its unique ID.
         * @summary Update variable
...
/**
 * Request parameters for createDeployment operation in FunctionsApi.
 * @export
 * @interface FunctionsApiCreateDeploymentRequest
 */
export type FunctionsApiCreateDeploymentRequest = {
    
    /**
    * Function ID.
    * @type {string}
    * @memberof FunctionsApiCreateDeployment
    */
...
/**
 * Request parameters for createFunction operation in FunctionsApi.
 * @export
 * @interface FunctionsApiCreateFunctionRequest
 */
export type FunctionsApiCreateFunctionRequest = {
...
/**
 * Request parameters for deleteFunctionById operation in FunctionsApi.
 * @export
 * @interface FunctionsApiDeleteFunctionByIdRequest
 */
export type FunctionsApiDeleteFunctionByIdRequest = {
    
    /**
    * Function ID.
    * @type {string}
    * @memberof FunctionsApiDeleteFunctionById
    */
    readonly functionId: string
...
/**
 * Request parameters for downloadDeploymentContents operation in FunctionsApi.
 * @export
 * @interface FunctionsApiDownloadDeploymentContentsRequest
 */
export type FunctionsApiDownloadDeploymentContentsRequest = {
    
    /**
    * Function ID.
    * @type {string}
    * @memberof FunctionsApiDownloadDeploymentContents
    */
    readonly functionId: string
...
/**
 * Request parameters for getFunctionUsage operation in FunctionsApi.
 * @export
 * @interface FunctionsApiGetFunctionUsageRequest
 */
export type FunctionsApiGetFunctionUsageRequest = {
    
    /**
    * Function ID.
    * @type {string}
    * @memberof FunctionsApiGetFunctionUsage
    */
    readonly functionId: string
...
/**
 * Request parameters for getUsageStats operation in FunctionsApi.
 * @export
 * @interface FunctionsApiGetUsageStatsRequest
 */
export type FunctionsApiGetUsageStatsRequest = {
    
    /**
    * Date range.
    * @type {'24h' | '30d' | '90d'}
    * @memberof FunctionsApiGetUsageStats
    */
    readonly range?: '24h' | '30d' | '90d'
...
/**
 * Request parameters for listAll operation in FunctionsApi.
 * @export
 * @interface FunctionsApiListAllRequest
 */
export type FunctionsApiListAllRequest = {
    
    /**
    * Array of query strings generated using the Query class provided by the SDK. [Learn more about queries](https://appwrite.io/docs/queries). Maximum of 100 queries are allowed, each 4096 characters long. You may filter on the following attributes: name, enabled, runtime, deployment, schedule, scheduleNext, schedulePrevious, timeout, entrypoint, commands, installationId
    * @type {Array<string>}
    * @memberof FunctionsApiListAll
    */
...
/**
 * Request parameters for retryBuild operation in FunctionsApi.
 * @export
 * @interface FunctionsApiRetryBuildRequest
 */
export type FunctionsApiRetryBuildRequest = {
    
    /**
    * Function ID.
    * @type {string}
    * @memberof FunctionsApiRetryBuild
    */
    readonly functionId: string
...
/**
 * Request parameters for updateDeploymentByFunctionAndId operation in FunctionsApi.
 * @export
 * @interface FunctionsApiUpdateDeploymentByFunctionAndIdRequest
 */
export type FunctionsApiUpdateDeploymentByFunctionAndIdRequest = {
    
    /**
    * Function ID.
    * @type {string}
    * @memberof FunctionsApiUpdateDeploymentByFunctionAndId
    */
    readonly functionId: string
...
export class FunctionsApiGenerated extends BaseAPI {
     ...
     */
    public createDeployment(requestParameters: FunctionsApiCreateDeploymentRequest, options?: AxiosRequestConfig) {
        return FunctionsApiFp(this.configuration).createDeployment(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FunctionsApiGenerated
     */
    public createFunction(requestParameters: FunctionsApiCreateFunctionRequest, options?: AxiosRequestConfig) {
        return FunctionsApiFp(this.configuration).createFunction(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FunctionsApiGenerated
     */
    public deleteFunctionById(requestParameters: FunctionsApiDeleteFunctionByIdRequest, options?: AxiosRequestConfig) {
        return FunctionsApiFp(this.configuration).deleteFunctionById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FunctionsApiGenerated
     */
    public downloadDeploymentContents(requestParameters: FunctionsApiDownloadDeploymentContentsRequest, options?: AxiosRequestConfig) {
        return FunctionsApiFp(this.configuration).downloadDeploymentContents(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FunctionsApiGenerated
     */
    public getFunctionUsage(requestParameters: FunctionsApiGetFunctionUsageRequest, options?: AxiosRequestConfig) {
        return FunctionsApiFp(this.configuration).getFunctionUsage(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FunctionsApiGenerated
     */
    public getUsageStats(requestParameters: FunctionsApiGetUsageStatsRequest = {}, options?: AxiosRequestConfig) {
        return FunctionsApiFp(this.configuration).getUsageStats(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FunctionsApiGenerated
     */
    public listAll(requestParameters: FunctionsApiListAllRequest, options?: AxiosRequestConfig) {
        return FunctionsApiFp(this.configuration).listAll(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FunctionsApiGenerated
     */
    public retryBuild(requestParameters: FunctionsApiRetryBuildRequest, options?: AxiosRequestConfig) {
        return FunctionsApiFp(this.configuration).retryBuild(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FunctionsApiGenerated
     */
    public updateDeploymentByFunctionAndId(requestParameters: FunctionsApiUpdateDeploymentByFunctionAndIdRequest, options?: AxiosRequestConfig) {
        return FunctionsApiFp(this.configuration).updateDeploymentByFunctionAndId(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
