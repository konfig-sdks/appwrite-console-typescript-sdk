...
// @ts-ignore
import { StorageCreateBucketRequest } from '../models';
// @ts-ignore
...
// @ts-ignore
import { UsageBuckets } from '../models';
// @ts-ignore
import { UsageStorage } from '../models';
...
export const StorageApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {StorageCreateBucketRequest} [storageCreateBucketRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createBucket: async (storageCreateBucketRequest?: StorageCreateBucketRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            requestBeforeHook({
                requestBody: storageCreateBucketRequest,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(storageCreateBucketRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        getBucket: async (bucketId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'bucketId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getBucketUsageStats: async (bucketId: string, range?: '24h' | '30d' | '90d', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'bucketId' is not null or undefined
            assertParamExists('getBucketUsageStats', 'bucketId', bucketId)
            const localVarPath = `/storage/{bucketId}/usage`
                .replace(`{${"bucketId"}}`, encodeURIComponent(String(bucketId !== undefined ? bucketId : `-bucketId-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/storage/{bucketId}/usage',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        getDownloadFile: async (bucketId: string, fileId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'bucketId' is not null or undefined
            assertParamExists('getDownloadFile', 'bucketId', bucketId)
            // verify required parameter 'fileId' is not null or undefined
            assertParamExists('getDownloadFile', 'fileId', fileId)
        ...
        getUsageStats: async (range?: '24h' | '30d' | '90d', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/storage/usage`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const StorageApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Create a new storage bucket.
         * @summary Create bucket
         * @param {StorageApiCreateBucketRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createBucket(requestParameters: StorageApiCreateBucketRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Bucket>> {
            const storageCreateBucketRequest: StorageCreateBucketRequest = {
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.createBucket(storageCreateBucketRequest, options);
         ...
         * @throws {RequiredError}
         */
        async getBucket(requestParameters: StorageApiGetBucketRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Bucket>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getBucket(requestParameters.bucketId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         * @summary Get bucket usage stats
         * @param {StorageApiGetBucketUsageStatsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getBucketUsageStats(requestParameters: StorageApiGetBucketUsageStatsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsageBuckets>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getBucketUsageStats(requestParameters.bucketId, requestParameters.range, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a file content by its unique ID. The endpoint response return with a \'Content-Disposition: attachment\' header that tells the browser to start downloading the file to user downloads directory.
         * @summary Get file for download
         * @param {StorageApiGetDownloadFileRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getDownloadFile(requestParameters: StorageApiGetDownloadFileRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getDownloadFile(requestParameters.bucketId, requestParameters.fileId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a file by its unique ID. This endpoint response returns a JSON object with the file metadata.
         ...
         * 
         * @summary Get storage usage stats
         * @param {StorageApiGetUsageStatsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getUsageStats(requestParameters: StorageApiGetUsageStatsRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsageStorage>> {
...
export const StorageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createBucket(requestParameters: StorageApiCreateBucketRequest, options?: AxiosRequestConfig): AxiosPromise<Bucket> {
            return localVarFp.createBucket(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Create a new file. Before using this route, you should create a new bucket resource using either a [server integration](https://appwrite.io/docs/server/storage#storageCreateBucket) API or directly from your Appwrite console.  Larger files should be uploaded using multiple requests with the [content-range](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Range) header to send a partial request with a maximum supported chunk of `5MB`. The `content-range` header values should always be in bytes.  When the first request is sent, the server will return the **File** object, and the subsequent part request must include the file\'s **id** in `x-appwrite-id` header to allow the server to know that the partial upload is for the existing file and not for a new one.  If you\'re creating a new file using one of the Appwrite SDKs, all the chunking logic will be managed by the SDK internally. 
         * @summary Create file
         ...
         * @throws {RequiredError}
         */
        getBucket(requestParameters: StorageApiGetBucketRequest, options?: AxiosRequestConfig): AxiosPromise<Bucket> {
            return localVarFp.getBucket(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get bucket usage stats
         ...
         * @throws {RequiredError}
         */
        getBucketUsageStats(requestParameters: StorageApiGetBucketUsageStatsRequest, options?: AxiosRequestConfig): AxiosPromise<UsageBuckets> {
            return localVarFp.getBucketUsageStats(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a file content by its unique ID. The endpoint response return with a \'Content-Disposition: attachment\' header that tells the browser to start downloading the file to user downloads directory.
         * @summary Get file for download
         ...
         * @throws {RequiredError}
         */
        getDownloadFile(requestParameters: StorageApiGetDownloadFileRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.getDownloadFile(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a file by its unique ID. This endpoint response returns a JSON object with the file metadata.
         * @summary Get file
         ...
         * @throws {RequiredError}
         */
        getUsageStats(requestParameters: StorageApiGetUsageStatsRequest = {}, options?: AxiosRequestConfig): AxiosPromise<UsageStorage> {
...
/**
 * Request parameters for createBucket operation in StorageApi.
 * @export
 * @interface StorageApiCreateBucketRequest
 */
export type StorageApiCreateBucketRequest = {
 ...
 */
export type StorageApiGetBucketRequest = {
...
/**
 * Request parameters for getBucketUsageStats operation in StorageApi.
 * @export
 * @interface StorageApiGetBucketUsageStatsRequest
 */
export type StorageApiGetBucketUsageStatsRequest = {
    
    /**
    * Bucket ID.
    * @type {string}
    * @memberof StorageApiGetBucketUsageStats
    */
    readonly bucketId: string
...
/**
 * Request parameters for getDownloadFile operation in StorageApi.
 * @export
 * @interface StorageApiGetDownloadFileRequest
 */
export type StorageApiGetDownloadFileRequest = {
    ...
    * @type {string}
    * @memberof StorageApiGetDownloadFile
    */
    readonly bucketId: string
...
/**
 * Request parameters for getUsageStats operation in StorageApi.
 * @export
 * @interface StorageApiGetUsageStatsRequest
 */
export type StorageApiGetUsageStatsRequest = {
    
    /**
    * Date range.
    * @type {'24h' | '30d' | '90d'}
    * @memberof StorageApiGetUsageStats
    */
    readonly range?: '24h' | '30d' | '90d'
...
export class StorageApiGenerated extends BaseAPI {
     ...
     */
    public createBucket(requestParameters: StorageApiCreateBucketRequest, options?: AxiosRequestConfig) {
        return StorageApiFp(this.configuration).createBucket(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getBucket(requestParameters: StorageApiGetBucketRequest, options?: AxiosRequestConfig) {
        return StorageApiFp(this.configuration).getBucket(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof StorageApiGenerated
     */
    public getBucketUsageStats(requestParameters: StorageApiGetBucketUsageStatsRequest, options?: AxiosRequestConfig) {
        return StorageApiFp(this.configuration).getBucketUsageStats(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof StorageApiGenerated
     */
    public getDownloadFile(requestParameters: StorageApiGetDownloadFileRequest, options?: AxiosRequestConfig) {
        return StorageApiFp(this.configuration).getDownloadFile(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof StorageApiGenerated
     */
    public getUsageStats(requestParameters: StorageApiGetUsageStatsRequest = {}, options?: AxiosRequestConfig) {
        return StorageApiFp(this.configuration).getUsageStats(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
