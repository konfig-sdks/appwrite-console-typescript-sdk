...
// @ts-ignore
import { AccountUpdateNameRequest } from '../models';
// @ts-ignore
...
// @ts-ignore
import { AccountUpdatePrefsOperationRequest } from '../models';
// @ts-ignore
...
export const AccountApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteSessions: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getPrefsOperation: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        listUserLogs: async (queries?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        logoutSession: async (sessionId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'sessionId' is not null or undefined
            assertParamExists('logoutSession', 'sessionId', sessionId)
            const localVarPath = `/account/sessions/{sessionId}`
                .replace(`{${"sessionId"}}`, encodeURIComponent(String(sessionId !== undefined ? sessionId : `-sessionId-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        sendVerificationSms: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/account/verification/phone`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @summary Update name
         * @param {AccountUpdateNameRequest} [accountUpdateNameRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateName: async (accountUpdateNameRequest?: AccountUpdateNameRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: accountUpdateNameRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(accountUpdateNameRequest, localVarRequestOptions, configuration)
         ...
         * @param {AccountUpdatePrefsOperationRequest} [accountUpdatePrefsOperationRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updatePrefsOperation: async (accountUpdatePrefsOperationRequest?: AccountUpdatePrefsOperationRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/account/prefs`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: accountUpdatePrefsOperationRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(accountUpdatePrefsOperationRequest, localVarRequestOptions, configuration)
...
export const AccountApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteSessions(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteSessions(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Delete the currently logged in user.
         ...
         * @throws {RequiredError}
         */
        async getPrefsOperation(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: any; }>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPrefsOperation(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Use this endpoint to get a logged in user\'s session using a Session ID. Inputting \'current\' will return the current session being used.
         ...
         * Get the list of latest security activity logs for the currently logged in user. Each log returns user IP address, location and date and time of log.
         * @summary List logs
         * @param {AccountApiListUserLogsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listUserLogs(requestParameters: AccountApiListUserLogsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LogList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listUserLogs(requestParameters.queries, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Logout the user. Use \'current\' as the session ID to logout on this device, use a session ID to logout on another device. If you\'re looking to logout the user on all devices, use [Delete Sessions](https://appwrite.io/docs/references/cloud/client-web/account#deleteSessions) instead.
         * @summary Delete session
         * @param {AccountApiLogoutSessionRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async logoutSession(requestParameters: AccountApiLogoutSessionRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.logoutSession(requestParameters.sessionId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Regenerate recovery codes that can be used as backup for MFA flow. Before regenerating codes, they must be first generated using [createMfaRecoveryCodes](/docs/references/cloud/client-web/account#createMfaRecoveryCodes) method. An OTP challenge is required to regenreate recovery codes.
         ...
         * @throws {RequiredError}
         */
        async sendVerificationSms(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Token>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.sendVerificationSms(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update currently logged in user account email address. After changing user address, the user confirmation status will get reset. A new confirmation email is not sent automatically however you can use the send confirmation email endpoint again to send the confirmation email. For security measures, user password is required to complete this request. This endpoint can also be used to convert an anonymous account to a normal one, by passing an email address and a new password. 
         ...
         * Update currently logged in user account name.
         * @summary Update name
         * @param {AccountApiUpdateNameRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateName(requestParameters: AccountApiUpdateNameRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>> {
            const accountUpdateNameRequest: AccountUpdateNameRequest = {
                name: requestParameters.name
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateName(accountUpdateNameRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update currently logged in user password. For validation, user is required to pass in the new password, and the old password. For users created with OAuth, Team Invites and Magic URL, oldPassword is optional.
         ...
         * Update currently logged in user account preferences. The object you pass is stored as is, and replaces any previous value. The maximum allowed prefs size is 64kB and throws error if exceeded.
         * @summary Update preferences
         * @param {AccountApiUpdatePrefsOperationRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updatePrefsOperation(requestParameters: AccountApiUpdatePrefsOperationRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>> {
            const accountUpdatePrefsOperationRequest: AccountUpdatePrefsOperationRequest = {
                prefs: requestParameters.prefs
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updatePrefsOperation(accountUpdatePrefsOperationRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async updateStatus(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>> {
...
export const AccountApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteSessions(options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteSessions(options).then((request) => request(axios, basePath));
        },
        /**
         * Delete the currently logged in user.
         * @summary Delete account
         ...
         * @throws {RequiredError}
         */
        getPrefsOperation(options?: AxiosRequestConfig): AxiosPromise<{ [key: string]: any; }> {
            return localVarFp.getPrefsOperation(options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to get a logged in user\'s session using a Session ID. Inputting \'current\' will return the current session being used.
         * @summary Get session
         ...
         * @throws {RequiredError}
         */
        listUserLogs(requestParameters: AccountApiListUserLogsRequest, options?: AxiosRequestConfig): AxiosPromise<LogList> {
         ...
         * @throws {RequiredError}
         */
        logoutSession(requestParameters: AccountApiLogoutSessionRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.logoutSession(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Regenerate recovery codes that can be used as backup for MFA flow. Before regenerating codes, they must be first generated using [createMfaRecoveryCodes](/docs/references/cloud/client-web/account#createMfaRecoveryCodes) method. An OTP challenge is required to regenreate recovery codes.
         * @summary Regenerate MFA Recovery Codes
         ...
         * @throws {RequiredError}
         */
        sendVerificationSms(options?: AxiosRequestConfig): AxiosPromise<Token> {
            return localVarFp.sendVerificationSms(options).then((request) => request(axios, basePath));
        },
        /**
         * Update currently logged in user account email address. After changing user address, the user confirmation status will get reset. A new confirmation email is not sent automatically however you can use the send confirmation email endpoint again to send the confirmation email. For security measures, user password is required to complete this request. This endpoint can also be used to convert an anonymous account to a normal one, by passing an email address and a new password. 
         * @summary Update email
         ...
         * @throws {RequiredError}
         */
        updateName(requestParameters: AccountApiUpdateNameRequest, options?: AxiosRequestConfig): AxiosPromise<User> {
         ...
         * @throws {RequiredError}
         */
        updatePrefsOperation(requestParameters: AccountApiUpdatePrefsOperationRequest, options?: AxiosRequestConfig): AxiosPromise<User> {
            return localVarFp.updatePrefsOperation(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Update push target
         ...
         * @throws {RequiredError}
         */
        updateStatus(options?: AxiosRequestConfig): AxiosPromise<User> {
...
/**
 * Request parameters for listUserLogs operation in AccountApi.
 * @export
 * @interface AccountApiListUserLogsRequest
 */
export type AccountApiListUserLogsRequest = {
    ...
    * @type {Array<string>}
    * @memberof AccountApiListUserLogs
    */
    readonly queries?: Array<string>
...
/**
 * Request parameters for logoutSession operation in AccountApi.
 * @export
 * @interface AccountApiLogoutSessionRequest
 */
export type AccountApiLogoutSessionRequest = {
    
    /**
    * Session ID. Use the string \'current\' to delete the current device session.
    * @type {string}
    * @memberof AccountApiLogoutSession
    */
    readonly sessionId: string
...
/**
 * Request parameters for updateName operation in AccountApi.
 * @export
 * @interface AccountApiUpdateNameRequest
 */
export type AccountApiUpdateNameRequest = {
...
/**
 * Request parameters for updatePrefsOperation operation in AccountApi.
 * @export
 * @interface AccountApiUpdatePrefsOperationRequest
 */
export type AccountApiUpdatePrefsOperationRequest = {
...
export class AccountApiGenerated extends BaseAPI {
     ...
     * @memberof AccountApiGenerated
     */
    public deleteSessions(options?: AxiosRequestConfig) {
        return AccountApiFp(this.configuration).deleteSessions(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteUser(options?: AxiosRequestConfig) {
        return AccountApiFp(this.configuration).deleteUser(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AccountApiGenerated
     */
    public getPrefsOperation(options?: AxiosRequestConfig) {
        return AccountApiFp(this.configuration).getPrefsOperation(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getUser(options?: AxiosRequestConfig) {
        return AccountApiFp(this.configuration).getUser(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AccountApiGenerated
     */
    public listUserLogs(requestParameters: AccountApiListUserLogsRequest, options?: AxiosRequestConfig) {
        return AccountApiFp(this.configuration).listUserLogs(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AccountApiGenerated
     */
    public logoutSession(requestParameters: AccountApiLogoutSessionRequest, options?: AxiosRequestConfig) {
        return AccountApiFp(this.configuration).logoutSession(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AccountApiGenerated
     */
    public sendVerificationSms(options?: AxiosRequestConfig) {
        return AccountApiFp(this.configuration).sendVerificationSms(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AccountApiGenerated
     */
    public updateName(requestParameters: AccountApiUpdateNameRequest, options?: AxiosRequestConfig) {
        return AccountApiFp(this.configuration).updateName(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AccountApiGenerated
     */
    public updatePrefsOperation(requestParameters: AccountApiUpdatePrefsOperationRequest, options?: AxiosRequestConfig) {
        return AccountApiFp(this.configuration).updatePrefsOperation(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public updateStatus(options?: AxiosRequestConfig) {
        return AccountApiFp(this.configuration).updateStatus(options).then((request) => request(this.axios, this.basePath));
    }
