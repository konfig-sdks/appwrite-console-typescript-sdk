...
export const LocaleApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getUserLocaleDetails: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const LocaleApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getUserLocaleDetails(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Locale>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getUserLocaleDetails(options);
         ...
         * @throws {RequiredError}
         */
        async listCurrencies(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CurrencyList>> {
...
export const LocaleApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getUserLocaleDetails(options?: AxiosRequestConfig): AxiosPromise<Locale> {
            return localVarFp.getUserLocaleDetails(options).then((request) => request(axios, basePath));
        },
        /**
         * List of all locale codes in [ISO 639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes).
         * @summary List Locale Codes
         ...
         * @throws {RequiredError}
         */
        listCurrencies(options?: AxiosRequestConfig): AxiosPromise<CurrencyList> {
...
export class LocaleApiGenerated extends BaseAPI {
     ...
     */
    public getUserLocaleDetails(options?: AxiosRequestConfig) {
        return LocaleApiFp(this.configuration).getUserLocaleDetails(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public listCurrencies(options?: AxiosRequestConfig) {
        return LocaleApiFp(this.configuration).listCurrencies(options).then((request) => request(this.axios, this.basePath));
    }
