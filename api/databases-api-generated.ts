...
// @ts-ignore
import { DatabasesCreateIndexOnAttributesRequest } from '../models';
// @ts-ignore
import { DatabasesCreateIntegerAttributeRequest } from '../models';
// @ts-ignore
import { DatabasesCreateIpAttributeRequest } from '../models';
// @ts-ignore
import { DatabasesCreateNewDatabaseRequest } from '../models';
// @ts-ignore
...
// @ts-ignore
import { DatabasesPatchDateTimeAttributeRequest } from '../models';
// @ts-ignore
...
// @ts-ignore
import { DatabasesUpdateIpAddressAttributeRequest } from '../models';
// @ts-ignore
...
// @ts-ignore
import { UsageCollection } from '../models';
// @ts-ignore
import { UsageDatabase } from '../models';
// @ts-ignore
import { UsageDatabases } from '../models';
...
export const DatabasesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} databaseId Database ID.
         * @param {string} collectionId Collection ID. You can create a new collection using the Database service [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection).
         * @param {DatabasesCreateIndexOnAttributesRequest} [databasesCreateIndexOnAttributesRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createIndexOnAttributes: async (databaseId: string, collectionId: string, databasesCreateIndexOnAttributesRequest?: DatabasesCreateIndexOnAttributesRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'databaseId' is not null or undefined
            assertParamExists('createIndexOnAttributes', 'databaseId', databaseId)
            // verify required parameter 'collectionId' is not null or undefined
            assertParamExists('createIndexOnAttributes', 'collectionId', collectionId)
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: databasesCreateIndexOnAttributesRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(databasesCreateIndexOnAttributesRequest, localVarRequestOptions, configuration)
         ...
         * @param {DatabasesCreateNewDatabaseRequest} [databasesCreateNewDatabaseRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNewDatabase: async (databasesCreateNewDatabaseRequest?: DatabasesCreateNewDatabaseRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: databasesCreateNewDatabaseRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(databasesCreateNewDatabaseRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        deleteIndexByKey: async (databaseId: string, collectionId: string, key: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'databaseId' is not null or undefined
            assertParamExists('deleteIndexByKey', 'databaseId', databaseId)
            // verify required parameter 'collectionId' is not null or undefined
            assertParamExists('deleteIndexByKey', 'collectionId', collectionId)
            // verify required parameter 'key' is not null or undefined
            assertParamExists('deleteIndexByKey', 'key', key)
         ...
         * @throws {RequiredError}
         */
        getCollectionUsageStats: async (databaseId: string, collectionId: string, range?: '24h' | '30d' | '90d', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'databaseId' is not null or undefined
            assertParamExists('getCollectionUsageStats', 'databaseId', databaseId)
            // verify required parameter 'collectionId' is not null or undefined
            assertParamExists('getCollectionUsageStats', 'collectionId', collectionId)
            const localVarPath = `/databases/{databaseId}/collections/{collectionId}/usage`
                .replace(`{${"databaseId"}}`, encodeURIComponent(String(databaseId !== undefined ? databaseId : `-databaseId-`)))
                .replace(`{${"collectionId"}}`, encodeURIComponent(String(collectionId !== undefined ? collectionId : `-collectionId-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/databases/{databaseId}/collections/{collectionId}/usage',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        getDocuments: async (databaseId: string, collectionId: string, queries?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'databaseId' is not null or undefined
            assertParamExists('getDocuments', 'databaseId', databaseId)
            // verify required parameter 'collectionId' is not null or undefined
            assertParamExists('getDocuments', 'collectionId', collectionId)
            const localVarPath = `/databases/{databaseId}/collections/{collectionId}/documents`
                .replace(`{${"databaseId"}}`, encodeURIComponent(String(databaseId !== undefined ? databaseId : `-databaseId-`)))
                .replace(`{${"collectionId"}}`, encodeURIComponent(String(collectionId !== undefined ? collectionId : `-collectionId-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        getUsageStats: async (range?: '24h' | '30d' | '90d', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/databases/usage`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getUsageStats_1: async (databaseId: string, range?: '24h' | '30d' | '90d', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'databaseId' is not null or undefined
            assertParamExists('getUsageStats_1', 'databaseId', databaseId)
            const localVarPath = `/databases/{databaseId}/usage`
                .replace(`{${"databaseId"}}`, encodeURIComponent(String(databaseId !== undefined ? databaseId : `-databaseId-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/databases/{databaseId}/usage',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        listAllDatabases: async (queries?: Array<string>, search?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/databases`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        listAttributes: async (databaseId: string, collectionId: string, queries?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'databaseId' is not null or undefined
            assertParamExists('listAttributes', 'databaseId', databaseId)
            // verify required parameter 'collectionId' is not null or undefined
            assertParamExists('listAttributes', 'collectionId', collectionId)
         ...
         * @throws {RequiredError}
         */
        listCollectionIndexes: async (databaseId: string, collectionId: string, queries?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'databaseId' is not null or undefined
            assertParamExists('listCollectionIndexes', 'databaseId', databaseId)
            // verify required parameter 'collectionId' is not null or undefined
            assertParamExists('listCollectionIndexes', 'collectionId', collectionId)
            const localVarPath = `/databases/{databaseId}/collections/{collectionId}/indexes`
                .replace(`{${"databaseId"}}`, encodeURIComponent(String(databaseId !== undefined ? databaseId : `-databaseId-`)))
                .replace(`{${"collectionId"}}`, encodeURIComponent(String(collectionId !== undefined ? collectionId : `-collectionId-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
         ...
         * @throws {RequiredError}
         */
        listCollectionLogs: async (databaseId: string, collectionId: string, queries?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'databaseId' is not null or undefined
            assertParamExists('listCollectionLogs', 'databaseId', databaseId)
            // verify required parameter 'collectionId' is not null or undefined
            assertParamExists('listCollectionLogs', 'collectionId', collectionId)
            const localVarPath = `/databases/{databaseId}/collections/{collectionId}/logs`
                .replace(`{${"databaseId"}}`, encodeURIComponent(String(databaseId !== undefined ? databaseId : `-databaseId-`)))
                .replace(`{${"collectionId"}}`, encodeURIComponent(String(collectionId !== undefined ? collectionId : `-collectionId-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/databases/{databaseId}/collections/{collectionId}/logs',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        listDocumentLogs: async (databaseId: string, collectionId: string, documentId: string, queries?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'databaseId' is not null or undefined
            assertParamExists('listDocumentLogs', 'databaseId', databaseId)
            // verify required parameter 'collectionId' is not null or undefined
            assertParamExists('listDocumentLogs', 'collectionId', collectionId)
            // verify required parameter 'documentId' is not null or undefined
            assertParamExists('listDocumentLogs', 'documentId', documentId)
            const localVarPath = `/databases/{databaseId}/collections/{collectionId}/documents/{documentId}/logs`
                .replace(`{${"databaseId"}}`, encodeURIComponent(String(databaseId !== undefined ? databaseId : `-databaseId-`)))
                .replace(`{${"collectionId"}}`, encodeURIComponent(String(collectionId !== undefined ? collectionId : `-collectionId-`)))
                .replace(`{${"documentId"}}`, encodeURIComponent(String(documentId !== undefined ? documentId : `-documentId-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/databases/{databaseId}/collections/{collectionId}/documents/{documentId}/logs',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        listLogs: async (databaseId: string, queries?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'databaseId' is not null or undefined
            assertParamExists('listLogs', 'databaseId', databaseId)
            const localVarPath = `/databases/{databaseId}/logs`
                .replace(`{${"databaseId"}}`, encodeURIComponent(String(databaseId !== undefined ? databaseId : `-databaseId-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/databases/{databaseId}/logs',
                httpMethod: 'GET'
            });
         ...
         * @param {string} collectionId Collection ID. You can create a new collection using the Database service [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection).
         * @param {string} key Attribute Key.
         * @param {DatabasesPatchDateTimeAttributeRequest} [databasesPatchDateTimeAttributeRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchDateTimeAttribute: async (databaseId: string, collectionId: string, key: string, databasesPatchDateTimeAttributeRequest?: DatabasesPatchDateTimeAttributeRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'databaseId' is not null or undefined
            assertParamExists('patchDateTimeAttribute', 'databaseId', databaseId)
            // verify required parameter 'collectionId' is not null or undefined
            assertParamExists('patchDateTimeAttribute', 'collectionId', collectionId)
            // verify required parameter 'key' is not null or undefined
            assertParamExists('patchDateTimeAttribute', 'key', key)
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: databasesPatchDateTimeAttributeRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(databasesPatchDateTimeAttributeRequest, localVarRequestOptions, configuration)
         ...
         * @param {string} collectionId Collection ID. You can create a new collection using the Database service [server integration](https://appwrite.io/docs/server/databases#databasesCreateCollection).
         * @param {string} key Attribute Key.
         * @param {DatabasesUpdateIpAddressAttributeRequest} [databasesUpdateIpAddressAttributeRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateIpAddressAttribute: async (databaseId: string, collectionId: string, key: string, databasesUpdateIpAddressAttributeRequest?: DatabasesUpdateIpAddressAttributeRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'databaseId' is not null or undefined
            assertParamExists('updateIpAddressAttribute', 'databaseId', databaseId)
            // verify required parameter 'collectionId' is not null or undefined
            assertParamExists('updateIpAddressAttribute', 'collectionId', collectionId)
            // verify required parameter 'key' is not null or undefined
            assertParamExists('updateIpAddressAttribute', 'key', key)
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: databasesUpdateIpAddressAttributeRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(databasesUpdateIpAddressAttributeRequest, localVarRequestOptions, configuration)
...
export const DatabasesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Creates an index on the attributes listed. Your index should include all the attributes you will query in a single request. Attributes can be `key`, `fulltext`, and `unique`.
         * @summary Create index
         * @param {DatabasesApiCreateIndexOnAttributesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createIndexOnAttributes(requestParameters: DatabasesApiCreateIndexOnAttributesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Index>> {
            const databasesCreateIndexOnAttributesRequest: DatabasesCreateIndexOnAttributesRequest = {
                key: requestParameters.key,
                type: requestParameters.type,
                attributes: requestParameters.attributes,
                orders: requestParameters.orders
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createIndexOnAttributes(requestParameters.databaseId, requestParameters.collectionId, databasesCreateIndexOnAttributesRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Create an integer attribute. Optionally, minimum and maximum values can be provided. 
         ...
         * Create a new Database. 
         * @summary Create database
         * @param {DatabasesApiCreateNewDatabaseRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNewDatabase(requestParameters: DatabasesApiCreateNewDatabaseRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Database>> {
            const databasesCreateNewDatabaseRequest: DatabasesCreateNewDatabaseRequest = {
                databaseId: requestParameters.databaseId,
                name: requestParameters.name,
                enabled: requestParameters.enabled
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNewDatabase(databasesCreateNewDatabaseRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Create relationship attribute. [Learn more about relationship attributes](https://appwrite.io/docs/databases-relationships#relationship-attributes). 
         ...
         * Delete an index.
         * @summary Delete index
         * @param {DatabasesApiDeleteIndexByKeyRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async deleteIndexByKey(requestParameters: DatabasesApiDeleteIndexByKeyRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteIndexByKey(requestParameters.databaseId, requestParameters.collectionId, requestParameters.key, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get attribute by ID.
         ...
         * 
         * @summary Get collection usage stats
         * @param {DatabasesApiGetCollectionUsageStatsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getCollectionUsageStats(requestParameters: DatabasesApiGetCollectionUsageStatsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsageCollection>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCollectionUsageStats(requestParameters.databaseId, requestParameters.collectionId, requestParameters.range, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a document by its unique ID. This endpoint response returns a JSON object with the document data.
         ...
         * Get a list of all the user\'s documents in a given collection. You can use the query params to filter your results.
         * @summary List documents
         * @param {DatabasesApiGetDocumentsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getDocuments(requestParameters: DatabasesApiGetDocumentsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DocumentList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getDocuments(requestParameters.databaseId, requestParameters.collectionId, requestParameters.queries, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get index by ID.
         ...
         * 
         * @summary Get databases usage stats
         * @param {DatabasesApiGetUsageStatsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getUsageStats(requestParameters: DatabasesApiGetUsageStatsRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsageDatabases>> {
         ...
         * 
         * @summary Get database usage stats
         * @param {DatabasesApiGetUsageStats0Request} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getUsageStats_1(requestParameters: DatabasesApiGetUsageStats0Request, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsageDatabase>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getUsageStats_1(requestParameters.databaseId, requestParameters.range, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a list of all databases from the current Appwrite project. You can use the search parameter to filter your results.
         * @summary List databases
         * @param {DatabasesApiListAllDatabasesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listAllDatabases(requestParameters: DatabasesApiListAllDatabasesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DatabaseList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listAllDatabases(requestParameters.queries, requestParameters.search, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List attributes in the collection.
         * @summary List attributes
         * @param {DatabasesApiListAttributesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listAttributes(requestParameters: DatabasesApiListAttributesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AttributeList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listAttributes(requestParameters.databaseId, requestParameters.collectionId, requestParameters.queries, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List indexes in the collection.
         * @summary List indexes
         * @param {DatabasesApiListCollectionIndexesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listCollectionIndexes(requestParameters: DatabasesApiListCollectionIndexesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IndexList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listCollectionIndexes(requestParameters.databaseId, requestParameters.collectionId, requestParameters.queries, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get the collection activity logs list by its unique ID.
         * @summary List collection logs
         * @param {DatabasesApiListCollectionLogsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listCollectionLogs(requestParameters: DatabasesApiListCollectionLogsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LogList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listCollectionLogs(requestParameters.databaseId, requestParameters.collectionId, requestParameters.queries, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a list of all collections that belong to the provided databaseId. You can use the search parameter to filter your results.
         ...
         * Get the document activity logs list by its unique ID.
         * @summary List document logs
         * @param {DatabasesApiListDocumentLogsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listDocumentLogs(requestParameters: DatabasesApiListDocumentLogsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LogList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listDocumentLogs(requestParameters.databaseId, requestParameters.collectionId, requestParameters.documentId, requestParameters.queries, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get the database activity logs list by its unique ID.
         * @summary List database logs
         * @param {DatabasesApiListLogsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listLogs(requestParameters: DatabasesApiListLogsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LogList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listLogs(requestParameters.databaseId, requestParameters.queries, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update a date time attribute. Changing the `default` value will not update already existing documents.
         * @summary Update dateTime attribute
         * @param {DatabasesApiPatchDateTimeAttributeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async patchDateTimeAttribute(requestParameters: DatabasesApiPatchDateTimeAttributeRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AttributeDatetime>> {
            const databasesPatchDateTimeAttributeRequest: DatabasesPatchDateTimeAttributeRequest = {
                required: requestParameters.required,
                default: requestParameters.default
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.patchDateTimeAttribute(requestParameters.databaseId, requestParameters.collectionId, requestParameters.key, databasesPatchDateTimeAttributeRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update a boolean attribute. Changing the `default` value will not update already existing documents.
         ...
         * Update an ip attribute. Changing the `default` value will not update already existing documents. 
         * @summary Update IP address attribute
         * @param {DatabasesApiUpdateIpAddressAttributeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateIpAddressAttribute(requestParameters: DatabasesApiUpdateIpAddressAttributeRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AttributeIp>> {
            const databasesUpdateIpAddressAttributeRequest: DatabasesUpdateIpAddressAttributeRequest = {
                required: requestParameters.required,
                default: requestParameters.default
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateIpAddressAttribute(requestParameters.databaseId, requestParameters.collectionId, requestParameters.key, databasesUpdateIpAddressAttributeRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update relationship attribute. [Learn more about relationship attributes](https://appwrite.io/docs/databases-relationships#relationship-attributes). 
...
export const DatabasesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createIndexOnAttributes(requestParameters: DatabasesApiCreateIndexOnAttributesRequest, options?: AxiosRequestConfig): AxiosPromise<Index> {
            return localVarFp.createIndexOnAttributes(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Create an integer attribute. Optionally, minimum and maximum values can be provided. 
         * @summary Create integer attribute
         ...
         * @throws {RequiredError}
         */
        createNewDatabase(requestParameters: DatabasesApiCreateNewDatabaseRequest, options?: AxiosRequestConfig): AxiosPromise<Database> {
         ...
         * @throws {RequiredError}
         */
        deleteIndexByKey(requestParameters: DatabasesApiDeleteIndexByKeyRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteIndexByKey(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Get attribute by ID.
         * @summary Get attribute
         ...
         * @throws {RequiredError}
         */
        getCollectionUsageStats(requestParameters: DatabasesApiGetCollectionUsageStatsRequest, options?: AxiosRequestConfig): AxiosPromise<UsageCollection> {
            return localVarFp.getCollectionUsageStats(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a document by its unique ID. This endpoint response returns a JSON object with the document data.
         * @summary Get document
         ...
         * @throws {RequiredError}
         */
        getDocuments(requestParameters: DatabasesApiGetDocumentsRequest, options?: AxiosRequestConfig): AxiosPromise<DocumentList> {
         ...
         * @throws {RequiredError}
         */
        getUsageStats(requestParameters: DatabasesApiGetUsageStatsRequest = {}, options?: AxiosRequestConfig): AxiosPromise<UsageDatabases> {
         ...
         * @throws {RequiredError}
         */
        getUsageStats_1(requestParameters: DatabasesApiGetUsageStats0Request, options?: AxiosRequestConfig): AxiosPromise<UsageDatabase> {
            return localVarFp.getUsageStats_1(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a list of all databases from the current Appwrite project. You can use the search parameter to filter your results.
         * @summary List databases
         ...
         * @throws {RequiredError}
         */
        listAllDatabases(requestParameters: DatabasesApiListAllDatabasesRequest, options?: AxiosRequestConfig): AxiosPromise<DatabaseList> {
            return localVarFp.listAllDatabases(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * List attributes in the collection.
         * @summary List attributes
         ...
         * @throws {RequiredError}
         */
        listAttributes(requestParameters: DatabasesApiListAttributesRequest, options?: AxiosRequestConfig): AxiosPromise<AttributeList> {
            return localVarFp.listAttributes(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * List indexes in the collection.
         * @summary List indexes
         ...
         * @throws {RequiredError}
         */
        listCollectionIndexes(requestParameters: DatabasesApiListCollectionIndexesRequest, options?: AxiosRequestConfig): AxiosPromise<IndexList> {
            return localVarFp.listCollectionIndexes(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Get the collection activity logs list by its unique ID.
         * @summary List collection logs
         ...
         * @throws {RequiredError}
         */
        listCollectionLogs(requestParameters: DatabasesApiListCollectionLogsRequest, options?: AxiosRequestConfig): AxiosPromise<LogList> {
            return localVarFp.listCollectionLogs(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a list of all collections that belong to the provided databaseId. You can use the search parameter to filter your results.
         * @summary List collections
         ...
         * @throws {RequiredError}
         */
        listDocumentLogs(requestParameters: DatabasesApiListDocumentLogsRequest, options?: AxiosRequestConfig): AxiosPromise<LogList> {
            return localVarFp.listDocumentLogs(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Get the database activity logs list by its unique ID.
         * @summary List database logs
         ...
         * @throws {RequiredError}
         */
        listLogs(requestParameters: DatabasesApiListLogsRequest, options?: AxiosRequestConfig): AxiosPromise<LogList> {
         ...
         * @throws {RequiredError}
         */
        patchDateTimeAttribute(requestParameters: DatabasesApiPatchDateTimeAttributeRequest, options?: AxiosRequestConfig): AxiosPromise<AttributeDatetime> {
            return localVarFp.patchDateTimeAttribute(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a boolean attribute. Changing the `default` value will not update already existing documents.
         * @summary Update boolean attribute
         ...
         * @throws {RequiredError}
         */
        updateIpAddressAttribute(requestParameters: DatabasesApiUpdateIpAddressAttributeRequest, options?: AxiosRequestConfig): AxiosPromise<AttributeIp> {
            return localVarFp.updateIpAddressAttribute(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Update relationship attribute. [Learn more about relationship attributes](https://appwrite.io/docs/databases-relationships#relationship-attributes). 
         * @summary Update relationship attribute
...
/**
 * Request parameters for createIndexOnAttributes operation in DatabasesApi.
 * @export
 * @interface DatabasesApiCreateIndexOnAttributesRequest
 */
export type DatabasesApiCreateIndexOnAttributesRequest = {
    
    /**
    * Database ID.
    * @type {string}
    * @memberof DatabasesApiCreateIndexOnAttributes
    */
    readonly databaseId: string
...
/**
 * Request parameters for createNewDatabase operation in DatabasesApi.
 * @export
 * @interface DatabasesApiCreateNewDatabaseRequest
 */
export type DatabasesApiCreateNewDatabaseRequest = {
...
/**
 * Request parameters for deleteIndexByKey operation in DatabasesApi.
 * @export
 * @interface DatabasesApiDeleteIndexByKeyRequest
 */
export type DatabasesApiDeleteIndexByKeyRequest = {
    
    /**
    * Database ID.
    * @type {string}
    * @memberof DatabasesApiDeleteIndexByKey
    */
    readonly databaseId: string
...
/**
 * Request parameters for getCollectionUsageStats operation in DatabasesApi.
 * @export
 * @interface DatabasesApiGetCollectionUsageStatsRequest
 */
export type DatabasesApiGetCollectionUsageStatsRequest = {
    
    /**
    * Database ID.
    * @type {string}
    * @memberof DatabasesApiGetCollectionUsageStats
    */
    readonly databaseId: string
...
/**
 * Request parameters for getDocuments operation in DatabasesApi.
 * @export
 * @interface DatabasesApiGetDocumentsRequest
 */
export type DatabasesApiGetDocumentsRequest = {
    
    /**
    * Database ID.
    * @type {string}
    * @memberof DatabasesApiGetDocuments
    */
    readonly databaseId: string
...
/**
 * Request parameters for getUsageStats operation in DatabasesApi.
 * @export
 * @interface DatabasesApiGetUsageStatsRequest
 */
export type DatabasesApiGetUsageStatsRequest = {
    
    /**
    * `Date range.
    * @type {'24h' | '30d' | '90d'}
    * @memberof DatabasesApiGetUsageStats
    */
    readonly range?: '24h' | '30d' | '90d'
...
/**
 * Request parameters for getUsageStats_1 operation in DatabasesApi.
 * @export
 * @interface DatabasesApiGetUsageStats0Request
 */
export type DatabasesApiGetUsageStats0Request = {
    
    /**
    * Database ID.
    * @type {string}
    * @memberof DatabasesApiGetUsageStats0
    */
    readonly databaseId: string
...
/**
 * Request parameters for listAllDatabases operation in DatabasesApi.
 * @export
 * @interface DatabasesApiListAllDatabasesRequest
 */
export type DatabasesApiListAllDatabasesRequest = {
    ...
    * @type {Array<string>}
    * @memberof DatabasesApiListAllDatabases
    */
    readonly queries?: Array<string>
...
/**
 * Request parameters for listAttributes operation in DatabasesApi.
 * @export
 * @interface DatabasesApiListAttributesRequest
 */
export type DatabasesApiListAttributesRequest = {
    
    /**
    * Database ID.
    * @type {string}
    * @memberof DatabasesApiListAttributes
    */
    readonly databaseId: string
...
/**
 * Request parameters for listCollectionIndexes operation in DatabasesApi.
 * @export
 * @interface DatabasesApiListCollectionIndexesRequest
 */
export type DatabasesApiListCollectionIndexesRequest = {
    
    /**
    * Database ID.
    * @type {string}
    * @memberof DatabasesApiListCollectionIndexes
    */
    readonly databaseId: string
...
/**
 * Request parameters for listCollectionLogs operation in DatabasesApi.
 * @export
 * @interface DatabasesApiListCollectionLogsRequest
 */
export type DatabasesApiListCollectionLogsRequest = {
    
    /**
    * Database ID.
    * @type {string}
    * @memberof DatabasesApiListCollectionLogs
    */
    readonly databaseId: string
...
/**
 * Request parameters for listDocumentLogs operation in DatabasesApi.
 * @export
 * @interface DatabasesApiListDocumentLogsRequest
 */
export type DatabasesApiListDocumentLogsRequest = {
    
    /**
    * Database ID.
    * @type {string}
    * @memberof DatabasesApiListDocumentLogs
    */
    readonly databaseId: string
...
/**
 * Request parameters for listLogs operation in DatabasesApi.
 * @export
 * @interface DatabasesApiListLogsRequest
 */
export type DatabasesApiListLogsRequest = {
    
    /**
    * Database ID.
    * @type {string}
    * @memberof DatabasesApiListLogs
    */
    readonly databaseId: string
...
/**
 * Request parameters for patchDateTimeAttribute operation in DatabasesApi.
 * @export
 * @interface DatabasesApiPatchDateTimeAttributeRequest
 */
export type DatabasesApiPatchDateTimeAttributeRequest = {
    
    /**
    * Database ID.
    * @type {string}
    * @memberof DatabasesApiPatchDateTimeAttribute
    */
    readonly databaseId: string
...
/**
 * Request parameters for updateIpAddressAttribute operation in DatabasesApi.
 * @export
 * @interface DatabasesApiUpdateIpAddressAttributeRequest
 */
export type DatabasesApiUpdateIpAddressAttributeRequest = {
    
    /**
    * Database ID.
    * @type {string}
    * @memberof DatabasesApiUpdateIpAddressAttribute
    */
    readonly databaseId: string
...
export class DatabasesApiGenerated extends BaseAPI {
     ...
     * @memberof DatabasesApiGenerated
     */
    public createIndexOnAttributes(requestParameters: DatabasesApiCreateIndexOnAttributesRequest, options?: AxiosRequestConfig) {
        return DatabasesApiFp(this.configuration).createIndexOnAttributes(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatabasesApiGenerated
     */
    public createNewDatabase(requestParameters: DatabasesApiCreateNewDatabaseRequest, options?: AxiosRequestConfig) {
        return DatabasesApiFp(this.configuration).createNewDatabase(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatabasesApiGenerated
     */
    public deleteIndexByKey(requestParameters: DatabasesApiDeleteIndexByKeyRequest, options?: AxiosRequestConfig) {
        return DatabasesApiFp(this.configuration).deleteIndexByKey(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatabasesApiGenerated
     */
    public getCollectionUsageStats(requestParameters: DatabasesApiGetCollectionUsageStatsRequest, options?: AxiosRequestConfig) {
        return DatabasesApiFp(this.configuration).getCollectionUsageStats(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatabasesApiGenerated
     */
    public getDocuments(requestParameters: DatabasesApiGetDocumentsRequest, options?: AxiosRequestConfig) {
        return DatabasesApiFp(this.configuration).getDocuments(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatabasesApiGenerated
     */
    public getUsageStats(requestParameters: DatabasesApiGetUsageStatsRequest = {}, options?: AxiosRequestConfig) {
        return DatabasesApiFp(this.configuration).getUsageStats(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatabasesApiGenerated
     */
    public getUsageStats_1(requestParameters: DatabasesApiGetUsageStats0Request, options?: AxiosRequestConfig) {
        return DatabasesApiFp(this.configuration).getUsageStats_1(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatabasesApiGenerated
     */
    public listAllDatabases(requestParameters: DatabasesApiListAllDatabasesRequest, options?: AxiosRequestConfig) {
        return DatabasesApiFp(this.configuration).listAllDatabases(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatabasesApiGenerated
     */
    public listAttributes(requestParameters: DatabasesApiListAttributesRequest, options?: AxiosRequestConfig) {
        return DatabasesApiFp(this.configuration).listAttributes(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatabasesApiGenerated
     */
    public listCollectionIndexes(requestParameters: DatabasesApiListCollectionIndexesRequest, options?: AxiosRequestConfig) {
        return DatabasesApiFp(this.configuration).listCollectionIndexes(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatabasesApiGenerated
     */
    public listCollectionLogs(requestParameters: DatabasesApiListCollectionLogsRequest, options?: AxiosRequestConfig) {
        return DatabasesApiFp(this.configuration).listCollectionLogs(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatabasesApiGenerated
     */
    public listDocumentLogs(requestParameters: DatabasesApiListDocumentLogsRequest, options?: AxiosRequestConfig) {
        return DatabasesApiFp(this.configuration).listDocumentLogs(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatabasesApiGenerated
     */
    public listLogs(requestParameters: DatabasesApiListLogsRequest, options?: AxiosRequestConfig) {
        return DatabasesApiFp(this.configuration).listLogs(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatabasesApiGenerated
     */
    public patchDateTimeAttribute(requestParameters: DatabasesApiPatchDateTimeAttributeRequest, options?: AxiosRequestConfig) {
        return DatabasesApiFp(this.configuration).patchDateTimeAttribute(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DatabasesApiGenerated
     */
    public updateIpAddressAttribute(requestParameters: DatabasesApiUpdateIpAddressAttributeRequest, options?: AxiosRequestConfig) {
        return DatabasesApiFp(this.configuration).updateIpAddressAttribute(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
